...
insert into quote(saying) values ("영원한건 아무것도 없다. 너무 스트레스를 받지 마라.\n상황이 얼마나 나쁘건간에 그것은 곧 변할 것이기 때문이다. -박신영");
insert into quote(saying) values ("우리네 삶에서의 모든 상황은 그저 찰나이다.\n상황이 좋지 않아도 점차 나아진다는 것을 기억하면 된다. -박신영");
insert into quote(saying) values ("타인이 너를 무엇으로 생각하는지는 중요치 않다.\n스스로 생각하는 너 자신이 너의 모든 것이다. -박신영");
insert into quote(saying) values ("타인의 삶과 비교하지 마라. 해와 달은 서로를 비교하는 법이 없다.\n그들은 단지 그들의 시간대에서 빛나고 있는 그 뿐이다. -박신영");
insert into quote(saying) values ("타인에게 영감을 주기 위해 네 인생을 살지 말고,\n너 자신에게 영감을 주는 인생을 살아라. -박신영");
insert into quote(saying) values ("타인이 널 좋아하도록 자신을 바꾸지 마라.\n오로지 솔직한 너 자신이 된다면\n올바른 사람들은 진짜 너의 모습을 사랑하게 될 것이다. -박신영");
